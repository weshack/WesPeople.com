# Django settings for wespeople project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'wespeople',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'wespeople_user',
        'PASSWORD': 'wespeople_user',
...
ALLOWED_HOSTS = ['localhost', 'wespeople.com', 'www.wespeople.com']
...
SECRET_KEY = '_$$(i386svj6ghxb=$!2elxzq0m5e6-21ip7o-t*h)$m(cmc1n'
...
ROOT_URLCONF = 'wespeople.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wespeople.wsgi.application'
